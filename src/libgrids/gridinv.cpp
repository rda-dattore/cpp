...
void GridInventory::fill_from_grid(const Grid *source,size_t format_number,float dataset_number,std::string filename)
{
  ...
  switch (format_number) {
    ...
    default:
    {
	std::cerr << "Unrecognized format number " << format_number << std::endl;
	exit(1);
    }
  }
