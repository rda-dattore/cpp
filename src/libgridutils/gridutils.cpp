...
bool fill_gaussian_latitudes(string path_to_gauslat_lists,my::map<Grid::GLatEntry>& gaus_lats,size_t num_circles,bool grid_scans_N_to_S)
{
...
string translate_grid_definition(string definition,bool getAbbreviation = false)
{
...
{
  string converted_grid_definition;
...
string convert_meta_grid_definition(string grid_definition,string definition_parameters,const char *separator)
{
  string s;
...
{
  string s,start_lat,end_lat,num_y;
...
bool fill_spatial_domain_from_grid_definition(string definition,string center,double& west_lon,double& south_lat,double& east_lon,double& north_lat)
{
  bool filled=false;
